...
public class Over64CharMail extends BaseTest {
    ...
    public void openSignUpAndVerify() {
        try {
            ...
            emailInput.sendKeys("hdfghfhfgdhdfghfdghfdghhhhhhhdfghsthstbthjrtjrtjtrjrtjddddddddddddddddd@gmail.com"); // Leave email input blank
