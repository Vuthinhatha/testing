...
public class Under64CharMail extends BaseTest {
    ...
    public void openSignUpAndVerify() {
        try {
            ...
            emailInput.sendKeys("hdfghfhfgdhdfghfdghfdghhhhhhhdfghsthstbthjrtjrtjtrj@gmail.com"); // Leave email input blank
