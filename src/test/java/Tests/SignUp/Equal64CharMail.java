...
public class Equal64CharMail extends BaseTest {
    ...
    public void openSignUpAndVerify() {
        try {
            ...
            emailInput.sendKeys("hdfghfhfgdhdfghfdghfdghhhhhhhdfghsthstbthjrtjrtjtrjrj@gmail.com"); // Leave email input blank
