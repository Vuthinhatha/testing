...
public class Payment extends BaseTest {
    ...
    public void noFillPhone() {
        ...
        try {
            ...
            wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[text()='Tiến hành đặt hàng']")))
                    .click();

            // form fill
            PayFormFill.fillForm(driver, "", "Nguyễn Văn A", "Hồ Chí Minh - Quận 1", "Phường Tân Định", "4A, Ngõ 6");
            ...
            Assert.assertTrue(errorMessage.isDisplayed(), "Error message for blank phone is not displayed!");
    ...
    public void blankPhone() {
        ...
        try {
            ...
            // form fill
            PayFormFill.fillForm(driver, "                          ", "Nguyễn Văn A", "Hồ Chí Minh - Quận 1",
    ...
    public void purchaseBlankCart() {
        ...
        try {
            ...
            boolean isCheckoutButtonPresent = driver.findElements(By.xpath("//button[text()='Tiến hành đặt hàng']"))
                    .size() > 0;

            Assert.assertFalse(isCheckoutButtonPresent,
                    "❌ 'Tiến hành đặt hàng' button should not be visible for a blank cart!");
            System.out.println("✅ Test passed: 'Tiến hành đặt hàng' button is not present for a blank cart.");
    ...
    public void changePaymentMethod() {
        ...
        try {
            ...
            String paymentText = vietcombankPaymentOption.getText();
